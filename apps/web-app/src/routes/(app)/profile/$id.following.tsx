...
import { useUserFollowing } from '@/api/followers';
...
export const Route = createFileRoute('/(app)/profile/$id/following')({
...
function FollowingPage() {
  ...
  // Use the API hook for following
  const { data: following, isLoading } = useUserFollowing(id);

  const filteredUsers = following?.following.filter(following =>
    following.following.name?.toLowerCase().includes(searchTerm.toLowerCase())
  ) || [];
                  ...
                  <Card key={followingData.following.id}>
                    <CardContent className="p-4">
                      <div className="flex items-center justify-between">
                        ...
                        {session?.user.id !== followingData.following.id && (
                          <FollowButton
